...
export PATH=${K8SFS_TARGET_LOCATION}/cfssl/${CFSSL_GIT_VERSION}/bin:${K8SFS_TARGET_LOCATION}/kubernetes/${KUBERNETES_GIT_VERSION}/bin:${K8SFS_TARGET_LOCATION}/go/${GO_VERSION}/bin:$PATH
